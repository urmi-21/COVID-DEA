...
outDir<-"C:/Users/mrbai/Desktop/mog_demo/limma_tissuewise/"
...
metadata<-metadata %>% drop_na(clinical.race,age_new,clinical.gender)
...
testCols<-c("clinical.gender","age_new")
...
testCols<-c("clinical.gender","clinical.disease","age_new")
lapp_out<-lapply(splitset, limma_listwise,cofacs=testCols)
#write to file
sapply(names(lapp_out), write_list_results)
